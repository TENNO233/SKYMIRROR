    ...
    *,
    ...
    with _STATUS_WRITE_LOCK:
        ...
        if final_state is not None:
            ...
            payload["validated_text"] = str(final_state.get("validated_text", "")).strip()
            ...
            payload["alerts"] = _coerce_list(final_state.get("alerts"))
...
def _compact_metadata(value: Any) -> dict[str, Any]:
    ...
    for key in ("guardrail", "validator", "orchestrator", "alert_manager"):
